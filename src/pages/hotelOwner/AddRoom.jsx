...
const [inputs, setInputs] = useState({
  ...
  return (
    ...
    <form>
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully to enchance the user booking experience.'/>
...
<div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
  {Object.keys(inputs.amenities).map((amenity, index)=>(
    <div key={index}>
      <input type="checkbox" id={`amenities${index+1}`} checked={inputs.amenities[amenity]} onChange={()=>setInputs({...input, amenities: {...inputs.amenities, [amenity]: !inputs.amenities [amenity] }})}/>
