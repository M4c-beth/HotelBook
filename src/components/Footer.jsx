    ...
    <div className=' bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                <div className='max-w-80'>
                    <img src={assets.logo} alt="logo" className='mb-4 h-15 md:h-20' />
                    <p className='text-sm'>
                        Your escape to the beautiful Costa Brava awaits. Discover more at Hotel Costa Brava.
                    </p>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5'>
                <p>© {new Date().getFullYear()} Hotel Costa Brava. All rights reserved.</p>
